...
class Create extends Conn{
     ...
     * Basta informar o nome da tabela e um array com nome da coluna e valor!
     * 
     * @param STRING $Tabela = nome da tabela no banco
     * @param ARRAY $Dados = array atribuitivo com os dados a serem gravados. ( Nome Da Coluna => Valor ).
     */
