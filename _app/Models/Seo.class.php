    ...
    private function getSeo() {
        ...
        switch ($this->File):
            ...
            case 'sobre':
                ...
                $this->seoData = ["sobre_link" => $this->Link, "sobre_cat" => $Name];
                $this->Data = ["Sobre " . SITENAME, "Conheça o profissional.", HOME . '/sobre/' . $this->Link, INCLUDE_PATH . '/images/site.png'];
                break;
            ...
            //SEO:: INDEX
            case 'index':
                $this->Data = [SITENAME . ' - Descomplicando a Informática para você', SITEDESC, HOME, INCLUDE_PATH . '/images/site.png'];
                break;
