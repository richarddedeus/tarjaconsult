...
class Email {
    ...
    public function Enviar(array $Data) {
        ...
        if (in_array('', $this->Data)):
            $this->Error = ['Erro ao enviar mensagem: Por favor preencha todos os campos!', WS_ALERT];
            $this->Result = false;
        elseif (!Check::Email($this->Data['RemetenteEmail'])):
            $this->Error = ['Erro ao enviar mensagem: E-mail inválido. Corrija seu E-mail!', WS_ALERT];
            $this->Result = false;
        else:
            $this->setMail();
            $this->Config();
