...
class Pager {
    ...
    public function ExePager($Page, $Limit) {
        ...
        $this->Anterior = (int) $Page - 1;
        $this->Proximo = (int) $Page + 1;
    }
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            if($this->Anterior > $this->First):
                $this->Paginator .= "<li><a title=\"Anterior\" href=\"{$this->Link}{$this->Anterior}\">&laquo;</a></li>";
            else:                 
                $this->Paginator .= "<li><a title=\"Anterior\" href=\"{$this->Link}1\">&laquo;</a></li>";
            endif;
            ...
            $this->Paginator .= "<li><a title=\"Próximo\" href=\"{$this->Link}{$this->Proximo}\">&raquo;</a></li>";
