...
//session_start();
$tinybrowser['sessioncheck'] = "YES"; //name of session variable to check
...
$tinybrowser['path']['image'] = '/uploads/media/'.date('Y').'/'.date('m').'/'; // Image files location
$tinybrowser['path']['media'] = '/uploads/media/'.date('Y').'/'.date('m').'/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/media/'.date('Y').'/'.date('m').'/'; // Other files location
