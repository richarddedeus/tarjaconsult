<div class="content list_content">
    ...
    <section>
        ...
        if ($empty):
            WSErro("Oppsss: Você tentou editar um post que não existe no sistema!", WS_INFORM);
        endif;
        ...
        if ($action):
            ...
            switch ($action):
                ...
                default :
                    WSErro("Ação não foi identifica pelo sistema!", WS_ERROR);
            endswitch;
        endif;
        ...
        if ($readPosts->getResult()):
            ...
            $Pager->ReturnPage();
            WSErro("Desculpe, ainda não existem posts cadastrados!", WS_INFORM);
        endif;
        ?>
