...
<div class="site-container">
    ...
    <section class="page_categorias">
        ...
        $Pager = new Pager(HOME . '/categoria/');
        $Pager->ExePager($getPage, 12);

        $readCat = new Read;
        $readCat->ExeRead("ws_posts", "WHERE post_status = 1  ORDER BY post_date DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
