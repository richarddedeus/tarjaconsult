...
<section class="main-slider">
    ...
    <div class="container">
        ...
        <div class="slidecount">
            <?php
            $cat = Check::CatByName('serviços');
            $post = new Read;
            $post->ExeRead("ws_posts", "WHERE post_status = 1 AND (post_cat_parent = :cat OR post_category = :cat) ORDER BY post_date DESC LIMIT :limit OFFSET :offset", "cat={$cat}&limit=5&offset=0");
            if (!$post->getResult()):
                WSErro('Desculpe, ainda não existem notícias cadastradas. Favor volte mais tarde!', WS_INFORM);
            else:
...
<div class="site-container">
    ...
    <section class="main-destaques">
        ...
        <section class="main_lastnews">
            ...
            if (!$post->getResult()):
                WSErro("Desculpe, não existe uma notícia destaque para ser exibida agora. Favor, volte depois!", WS_INFORM);
            else:
            ...
            <div class="last_news">
                ...
                if (!$post->getResult()):
                    WSErro("Desculpe, não temos mais notícias para serem exibidas aqui. Favor, volte depois!", WS_INFORM);
                else:
            ...
            <nav class="guia_comercial">
                ...
                <div class="tab comer">
                    ...
                    if (!$empresa->getResult()):
                        WSErro("Desculpe, não existem empresas cadastradas na categoria ONDE COMER. Favor, volte depois!", WS_INFORM);
                    else:
                ...
                <div class="tab ficar none">
                    ...
                    if (!$empresa->getResult()):
                        WSErro("Desculpe, não existem empresas cadastradas na categoria ONDE FICAR. Favor, volte depois!", WS_INFORM);
                    else:
                        foreach ($empresa->getResult() as $emp):
                            $View->Show($emp, $tpl_empresa);
                        endforeach;
                ...
                <div class="tab comprar none">
                    ...
                    $empresa->setPlaces("empcat={$empcat}");
                    if (!$empresa->getResult()):
                        WSErro("Desculpe, não existem empresas cadastradas na categoria ONDE COMPRAR. Favor, volte depois!", WS_INFORM);
                    else:
                        foreach ($empresa->getResult() as $emp):
                            $View->Show($emp, $tpl_empresa);
                        endforeach;
                ...
                <div class="tab divertir none">
                    ...
                    $empresa->setPlaces("empcat={$empcat}");
                    if (!$empresa->getResult()):
                        WSErro("Desculpe, não existem empresas cadastradas na categoria ONDE SE DIVERTIR. Favor, volte depois!", WS_INFORM);
                    else:
                        foreach ($empresa->getResult() as $emp):
                            $View->Show($emp, $tpl_empresa);
                        endforeach;
        ...
        <aside>
            ...
            if (!$asideposts->getResult()):
                WSErro("Desculpe, nem uma notícia em destaque neste momento. Favor, volte depois!", WS_INFORM);
            else:
